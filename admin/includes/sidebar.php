<nav class="ts-sidebar">
    <ul class="ts-sidebar-menu">
        ...
        <!-- <li><a href="#"><i class="fa fa-calendar"></i> Leave Management</a>
            <ul>
                <li><a href="manage_leave.php">Manage Leave Requests</a></li>
            </ul>
        </li> -->

        <li><a href="manage_leave.php"><i class="fa fa-calendar"></i> Leave Management</a></li>
