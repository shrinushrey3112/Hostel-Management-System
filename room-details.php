	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top: 45px;">Rooms Details</h2>
										...
										while ($row = $res->fetch_object()) {
											...
											<tr>
												...
												<td><a href="javascript:void(0);"
														onClick="popUpWindow('http://localhost/hostel/full-profile.php?id=<?php echo $row->emailid; ?>');"
											...
											<tr>
												...
												<td colspan="3"><?php echo $row->guardianEmail; ?></td>
											</tr>
